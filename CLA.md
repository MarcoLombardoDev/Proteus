...
Subject to the terms and conditions of this Agreement, You hereby grant to the Project Owner a **perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable copyright license** to:
...
Subject to the terms and conditions of this Agreement, You hereby grant to the Project Owner a **perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable patent license** to make, have made, use, offer to sell, sell, import, and otherwise transfer the Project, where such license applies only to patent claims licensable by You that are **necessarily infringed** by Your Contribution(s) alone or by combination of Your Contribution(s) with the Project as it existed at the time of submission.

If any entity institutes patent litigation against the Project Owner or any user of the Project alleging that Your Contribution constitutes patent infringement, then any patent licenses granted to the Project Owner under this Agreement shall terminate as of the date such litigation is filed.
...
4. **No third-party branding.** Your Contribution does not introduce logos, icons, trademarks, or other brand assets belonging to a third party. This Project replaces graphic assets for a living, so this point matters here more than usual: sample images, test fixtures, and screenshots must use neutral or synthetic artwork, never a real organisation's marks.
...
To the maximum extent permitted under applicable law, You hereby waive and agree not to assert any moral rights You may have in Your Contributions (including rights of integrity and rights of attribution beyond basic authorship credit in the project's commit history).

---

## 7. No Obligation to Use

This Agreement does not obligate the Project Owner to use, incorporate, or distribute Your Contributions. The Project Owner may reject, modify, or remove any Contribution at any time at their sole discretion, with or without explanation.
...
This Agreement shall be governed by and construed in accordance with the laws of Italy, without regard to its conflict-of-law provisions.

---

## 10. How to Sign

**Individual contributors:** Simply submit a Pull Request to this repository. Include the following statement in your PR description:

```
I have read and agree to the Contributor License Agreement (CLA.md).
```

Your GitHub username and the PR submission date serve as your electronic signature.
